...
-- + {opt_frame_spec}: ok
-- + {detail 131084} {frame_type_groups} {frame_boundary_unbounded} {frame_exclude_ties}
-- + {expr_list}
-- + {window_func_inv}: integer notnull
-- + {opt_frame_spec}: ok
-- + {detail 36994} {frame_type_rows} {frame_boundary_start_preceding} {frame_boundary_end_following} {frame_exclude_current_row}
-- - error:
select id,
