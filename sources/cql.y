...
cql_noexport CSTR cql_builtin_text() {
  return
    ...
    "[[builtin]]"
    "declare function cql_format_bool(val bool) create text!;"
    "[[builtin]]"
    "declare function cql_format_int(val int) create text!;"
    "[[builtin]]"
    "declare function cql_format_long(val long) create text!;"
    "[[builtin]]"
    "declare function cql_format_double(val real) create text!;"
    "[[builtin]]"
    "declare function cql_format_string(val text) create text!;"
    "[[builtin]]"
    "declare function cql_format_blob(val blob) create text!;"
    "[[builtin]]"
    "declare function cql_format_object(val object) create text!;"
    "[[builtin]]"
    "declare function cql_format_null(ignored bool) create text!;"
