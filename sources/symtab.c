...
static void symtab_rehash(CqlState* _Nonnull CS, symtab *syms);
...
cql_noexport void symtab_delete(CqlState* _Nonnull CS, symtab *syms) {
  if (syms->teardown) {
...
cql_noexport bool_t symtab_add(CqlState* _Nonnull CS, symtab *syms, const char *sym_new, void *val_new) {
...
static void symtab_teardown(CqlState* _Nonnull CS, void *val) {
  symtab_delete(CS, val);
}

// second special case teardown 
//  * a symbol table with payload of bytebuffers
static void bytebuf_teardown(CqlState* _Nonnull CS, void *val) {
...
static void charbuf_teardown(CqlState* _Nonnull CS, void *val) {
...
cql_noexport symtab *_Nonnull symtab_ensure_symtab(CqlState* _Nonnull CS, symtab *syms, const char *name) {
...
cql_noexport bool_t symtab_add_symtab(CqlState* _Nonnull CS, symtab *syms, CSTR name, symtab *data) {
  syms->teardown = symtab_teardown;
...
cql_noexport bytebuf *_Nonnull symtab_ensure_bytebuf(CqlState* _Nonnull CS, symtab *syms, const char *sym_new) {
...
cql_noexport void symtab_append_bytes(CqlState* _Nonnull CS, symtab *syms, const char *sym_new, const void *bytes, size_t count) {
...
cql_noexport charbuf *_Nonnull symtab_ensure_charbuf(CqlState* _Nonnull CS, symtab *syms, const char *sym_new) {
