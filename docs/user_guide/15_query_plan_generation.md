...
In order to flexibly create query plans, CQL uses `--rt query_plan`
...
as the "main" function, or you can make your own.
...
> results in the creation of similarly named "normal" tables which will be used in the query instead
