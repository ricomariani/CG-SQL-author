...
typedef struct symtab {
  ...
  void (*_Nullable teardown)(CqlState* _Nonnull CS, void *_Nonnull val);
} symtab;
...
cql_noexport void symtab_delete(CqlState* _Nonnull CS, symtab *_Nonnull syms);
cql_noexport bool_t symtab_add(CqlState* _Nonnull CS, symtab *_Nonnull syms, const char *_Nonnull sym_new, void *_Nullable val_new);
...
// these are commmon.
cql_noexport bytebuf *_Nonnull symtab_ensure_bytebuf(CqlState* _Nonnull CS, symtab *_Nonnull syms, const char *_Nonnull sym_new);
cql_noexport void symtab_append_bytes(CqlState* _Nonnull CS, symtab *_Nonnull syms, const char *_Nonnull sym_new, const void *_Nullable bytes, size_t count);
cql_noexport symtab *_Nonnull symtab_ensure_symtab(CqlState* _Nonnull CS, symtab *_Nonnull syms, const char *_Nonnull name);
cql_noexport bool_t symtab_add_symtab(CqlState* _Nonnull CS, symtab *_Nonnull syms, CSTR _Nonnull name, symtab *_Nonnull data);
cql_noexport charbuf *_Nonnull symtab_ensure_charbuf(CqlState* _Nonnull CS, symtab *_Nonnull syms, const char *_Nonnull sym_new);
