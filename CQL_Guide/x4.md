...
A function delcared with `declare select function` will be called by SQLite, it has not possibilty
of having a call-by-reference out argument.  Therefore these are disallowed.
