...
* `REGION` is used to identify AST fragments that correspond to schema regions
   * see [Chapter 10](user_guide.html#chapter-10-schema-management-features) of the Guide for more information on regions
...
[Chapter 5](user_guide.html#reshaping-data-cursor-like-forms) of the CQL Guide. But before we get
...
more fully explained in [Chapter 5](user_guide.html#reshaping-data-cursor-like-forms) of the Guide,
...
is described more fully in [Chapter 10](user_guide.html#schema-regions) of the Guide.
