...
|Command|Details|
|:----------------------------|:------|
|`./test.sh` | Build the compiler and run the suite. This is the bread and butter of the dev cycle.|
...
|`--use_clang`| Clang finds more warnings than GCC in general, recommended before any PR.|
