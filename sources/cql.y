...
cql_noexport CSTR cql_builtin_text() {
  return
    ...
    "[[builtin]]"
    "declare function cql_cursor_column_count(C cursor) int!;"
    "[[builtin]]"
    "declare function cql_cursor_column_type(C cursor, icol int!) int!;"
    "[[builtin]]"
    "declare function cql_cursor_get_bool(C cursor, icol int!) bool;"
    "[[builtin]]"
    "declare function cql_cursor_get_int(C cursor, icol int!) int;"
    "[[builtin]]"
    "declare function cql_cursor_get_long(C cursor, icol int!) long;"
    "[[builtin]]"
    "declare function cql_cursor_get_real(C cursor, icol int!) real;"
    "[[builtin]]"
    "declare function cql_cursor_get_text(C cursor, icol int!) text;"
    "[[builtin]]"
    "declare function cql_cursor_get_blob(C cursor, icol int!) blob;"
    "[[builtin]]"
    "declare function cql_cursor_get_object(C cursor, icol int!) object;"
    "[[builtin]]"
